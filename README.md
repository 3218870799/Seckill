...
目的：这是一个跟着慕课网老师做的秒杀系统，主要用来学习高并发API事务管理
...
知识记录：
	竞争：
		...
		行级锁：当update时该线程获得锁，其他线程等待，当该线程commit后其他线程再获得锁
				难点：如何高效处理竞争
	高并发优化分析以及优化思路
		1：详情页：部署到CDN上，一般静态资源基本都在CDN上，不用访问系统	
		2：获取系统时间：用户可能会不断刷新获取系统时间，但是访问内存只需10ns，一般不需要优化
